...
valeur_enlevé = etudiant.pop('age')
print (valeur_enlevé)
print(F"on a enlevé l'âge de l'étudiant, sa valeur était: {valeur_enlevé}")
...
print (f"Nous avons maintenant {nb_paires} paires clés valeurs.")